...
class ExchangeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final loading = ref.watch(loadingListExchangesProvider);
                      ...
                      return Dismissible(
                        ...
                        onDismissed: (direction) {
                          ref
                              ...
                              .removeExchange(
                                  sessionExchanges[index].offeringUser);
                        },
                        child: ExchangeCard(
                          onTap: () async {
                            ref
                                .read(
                                    currentSessionExchangeInformation.notifier)
                      ...
                      return ExchangeCard(
                        onTap: () => {
                          ref
                              ...
                              .update((state) => acceptedExchangeList[index]),
                          context.pushNamed(
