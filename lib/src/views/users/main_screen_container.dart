...
class _MainScreenState extends ConsumerState<MainScreen> {
  ...
  Future<void> _loadData() async {
    ...
    ref.read(exchangeDataProvider).listExchanges(userId);
  }
  ...
  Widget build(BuildContext context) {
    ...
    final pendingExchanges = ref.watch(exchangeFilterPendingProvider).length;
        ...
        actions: [
          ...
          IconButton(
            ...
            icon: Badge.count(
              ...
              isLabelVisible: pendingExchanges > 0,
